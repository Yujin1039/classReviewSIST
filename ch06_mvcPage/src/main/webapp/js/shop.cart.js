$(function(){
	...
	$('.cart-modify').on('click',function(){
		//변경 버튼 위에 있는 수량 값을 가져옴    같은 부모                찾고자 하는 태그+속성 
		...
		//input_quantity.val(): 변경된 값, input_quantity.attr('value'): 기존의 데이터
		...
		$.ajax({
			url:'modifyCart.do',
			type:'post',
			data:{cart_num:$(this).attr('data-cartnum'),item_num:$(this).attr('data-itemnum'),
