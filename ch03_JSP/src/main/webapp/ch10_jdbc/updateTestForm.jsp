...
%>
		<form id="myForm" action="updateTest.jsp" method="post">
			<!-- 기본키인 번호가 수정되지 않도록 하기 위해 hidden type으로 전송 -->
			<input type="hidden" name="num" value="<%= num %>">
			<ul>
				<li>
					<label for="name">이름</label> 
					<!-- value값을 지정하여 기존에 작성한 내용을 폼에 불러옴 -->
				...
				<li>
					...
					<!-- textarea태그에서 기존에 작성한 내용을 불러오려면 태그 사이에 값을 불러옴 -->
			...
			<div class="align-center">
				...
				<input type="button"
					value="목록" onclick="location.href='selectTest.jsp'">
			</div>
		</form>
<% 						
		}else{//주소의 num 조작
