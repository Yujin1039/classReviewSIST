$(function(){
	...
	$('#order_quantity').on('keyup mouseup',function(){
		...
		$('#item_total_txt').text('총 주문금액 : '+total.toLocaleString()+'원');
		                                      /*숫자 세자리씩 끊어서 ","로 표현*/
	});
	/* =====================
	 * 
	...
	$('#item_cart').submit(function(event){
		...
		//기본 이벤트 제거 -> ajax통신을 이용하므로 submit버튼이 활성화되지 않아야 함
