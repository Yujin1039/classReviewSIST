	...
	<div class="content-main">
		...
		<div class="item-detail">
			<form id="item_cart">
				...
				<ul>
					<li>가격 : <b><fmt:formatNumber value="${item.price}"/>원</b>
					...
					<li>
						...
						<input type="number" name="order_quantity" min="1" 
								max="${item.quantity}" id="order_quantity" class="quantity-width">
					</li>
					<li>
					...
					<c:if test="${item.quantity <= 0}"><!-- 사람이 입력하므로 quantity가 음수가 될 수 있음 -->
